...
--- KAFKA_SECURITY_PROTOCOL (cette ligne est une mise à jour) <br>
--- KAFKA_SASL_MECHANISM <br>
--- KAFKA_SASL_MECHANISM_INTER_BROKER_PROTOCOL <br>
--- KAFKA_SASL_ENABLED_MECHANISMS <br>
--- KAFKA_OPTS <br>
--- KAFKA_LISTENER_SECURITY_PROTOCOL_MAP (cette ligne est une mise à jour) <br>
